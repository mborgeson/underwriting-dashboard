...
class CellReferenceParser:
    ...
    def _extract_text_component(self, column_name: str) -> Tuple[str, Optional[str]]:
        """
                ...
                if ref["type"] == "text":
                    ...
                    if ref["sheet_name"] in sheet_data:
                        ...
                        if ref["is_col_range"] and not ref["is_row_range"]:
                            ...
                            column_name_parts = self._extract_text_component(ref["column_name"])
