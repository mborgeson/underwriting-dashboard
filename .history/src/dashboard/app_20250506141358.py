...
def render_analytics(data, is_mobile=False):
    ...
    # Import the enhanced analytics components
    from src.dashboard.components.analytics import render_enhanced_analytics
    
    # Run enhanced analytics with appropriate sizing for mobile/desktop
    if is_mobile:
        # Simpler layout for mobile
        render_enhanced_analytics(data)
    else:
...
def run_dashboard():
    ...
    st.sidebar.markdown("### Debug: Sidebar is working")  # Added debug text
