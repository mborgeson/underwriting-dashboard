...
def render_sidebar_filters(compact=False):
    ...
    # Debug text to verify sidebar is working
    st.sidebar.markdown("### Debug: Sidebar is working")
    
    st.sidebar.title("Filters" if not compact else "📊 Filters")
    
    # Search box - simple version for testing
    ...
    with st.sidebar.expander("Debug Info", expanded=False):
        st.write("Current filters:", st.session_state.get('filters', {}))
        st.write("Search term:", st.session_state.get('search_term', ''))