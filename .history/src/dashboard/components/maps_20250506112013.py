...
def render_property_map(data):
    ...
    potential_lat_columns = [
        'Propety_Info__Deal_Latitude_', 
        'Latitude', 
        'Property_Latitude',
        'Lat'
    ]
    
    potential_lng_columns = [
        'Propety_Info__Deal_Longitude_', 
        'Longitude', 
        'Property_Longitude',
        'Lng'
    ]
    
    for col in potential_lat_columns:c
        if col in data.columns:
            lat_col = col
            break
    
    for col in potential_lng_columns:
        if col in data.columns:
            lng_col = col
            break
