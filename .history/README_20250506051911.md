...
2. Create a conda environment from the conda environment file: `conda env create -f environment.yml`
3. Activate the environment: `conda activate underwriting_dashboard`
4. Configure paths in the `config/config.py` file if needed
