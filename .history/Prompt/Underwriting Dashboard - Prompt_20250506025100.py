...
1. **PROJECT PART #1: Identify Files in a Top-Level Directory that will be Read into a DataFrame, based upon meeting certain criteria, and then uploaded to a Database**:
    A). To create project code that id the specified excel files within a directory in order to pull specific information from only those excel files that are underwriting models.
