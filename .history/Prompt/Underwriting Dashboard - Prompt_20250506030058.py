...
3. **Key Requirements**:
    (I) Prior to providing the code to achieve the project objectives, the agent should provide a high-level overview of the code and how it will work to achieve the project objectives. This overview should include a description of the key components of the code, how they will work together, and any assumptions or limitations of the code. The agent should also provide a brief explanation of the key packages and libraries that will be used in the code, as well as any relevant documentation or resources for those packages and libraries;
    ...
    (VIII) The code should be flexible and extensible, with a focus on reusability and maintainability;
