...
1. **User Software**:
    ...
    (I) IDE: Jupyter Notebooks within Visual Studio Code;
    (I) Programming Language: Python;
    (I) AI LLM Platform: Claude/Claude Desktop;
    (I) Input Files and File Tyoes: Excel (“.xlsx”, “.xlsb”, and/or “.xlsm”)
    (I) Input File location(s): Windows Explorer Folders on my laptop
