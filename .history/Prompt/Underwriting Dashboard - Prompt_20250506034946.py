...
9. **Visual References**:
    (I) The following are links to visual references of dashboards that the user would like to use as a reference for the dashboard design:
        (i) https://www.datapine.com/blog/wp-content/uploads/2020/01/real-estate-dashboard-example.png
        (ii) https://www.datapine.com/blog/wp-content/uploads/2020/01/real-estate-dashboard-example-2.png
        (iii) https://www.datapine.com/blog/wp-content/uploads/2020/01/real-estate-dashboard-example-3.png
        (iv) https://www.datapine.com/blog/wp-content/uploads/2020/01/real-estate-dashboard-example-4.png
