...
3. **Key Requirements**:
    (I) Prior to providing the code to achieve the project objectives, the agent should provide a high-level overview of the code and how it will work to achieve the project objectives.
        ...
        (iv) The agent should provide a recommended project directory structure for the project, including the version numbers of each package, and any relevant documentation or resources for those packages;
