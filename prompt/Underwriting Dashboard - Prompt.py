...
1. **PROJECT PART #1: Identify Files in a Top-Level Directory that will be Read into a DataFrame, based upon meeting certain criteria, and then uploaded to a Database**:
    ...
    C). Once inside each of the directories listed within the "first-level deal subdirectories", the project will loop through each of the folders with the deal folder and find the "UW Model" folder. Next the project will loop through each of the files in the "UW Folder" for the below criteria:
        (I) File Criteria:
            ...
            (iv) The last modified date of the file must be in the following date range - Last Modified Date >= 7/15/2024;
...
1. **User Software**:
    ...
    (V) Input Files and File Types: Excel (".xlsb" and/or ".xlsm"); and
...
9. **Visual References**:
    (I) The following are links to visual references of dashboards that the user would like to use as a reference for the dashboard design:
        (i) https://www.behance.net/gallery/217876081/Real-Estate-Platform-Property-Management-SaaS-Web-App?tracking_source=search_projects|real+estate+dashboard&l=9
        (ii) https://dribbble.com/shots/25977418-Real-Estate-Dashboard-UI
        (iii) https://dribbble.com/shots/21994011-Realys-Real-Estate-Dashboard
        (iv) https://dribbble.com/shots/23548375-Real-Estate-Dashboard
        (v) https://dribbble.com/shots/25900699-Omala-Real-Estate-Management-Dashboard-Figma
        (vi) https://www.dealpath.com/wp-content/uploads/2024/10/real-estate-acquisitions-dashboards-1536x864.png.webp
        (vii) https://www.dealpath.com/wp-content/uploads/2024/10/real-estate-debt-dashboard-1536x864.png.webp
        (viii) https://www.dealpath.com/wp-content/uploads/2024/10/multifamily-real-estate-dashboard-1536x864.png.webp 
        (ix) https://www.dealpath.com/wp-content/uploads/2024/10/real-estate-portfolio-dashboard-1536x864.png.webp
        (x) https://www.dealpath.com/wp-content/uploads/2024/10/reeal-estate-disposition-dashboard-1536x864.png.webp
